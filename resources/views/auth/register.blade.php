								...
								<div class="card mt-5">
										...
										<div class="card-body">
												<form method="POST" action="{{ route('register') }}">
														...
														<div class="row mb-3">
																<label for="email" class="col-md-4 col-form-label text-md-end">ที่อยู่อีเมล์</label>
														...
														<div class="row mb-3">
																<label for="username" class="col-md-4 col-form-label text-md-end">ชื่อผู้ใช้งาน</label>
